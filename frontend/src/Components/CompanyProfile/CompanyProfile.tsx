...
const tableConfig = [
  ...
  },
  {
    ...
    render: (company: CompanyKeyMetrics) => company.capexToDepreciationTTM,
    subTitle:
  ...
  },
  {
    ...
    render: (company: CompanyKeyMetrics) => company.stockBasedCompensationToRevenueTTM,
    subTitle: 
  ...
  },
  {
    ...
    render: (company: CompanyKeyMetrics) => company.averageReceivablesTTM,
    subTitle:
  ...
  },
  {
    ...
    render: (company: CompanyKeyMetrics) => company.operatingCycleTTM,
    subTitle:
